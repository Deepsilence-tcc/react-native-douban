        ...
        return(
            <TouchableOpacity style={[styles.row, styles.item]} {...this.props}>
                ...
                <View style={styles.content}>
                    <View>
                        <Text style={{width:200}} numberOfLines={1}>{row.book.title}</Text>
                    </View>
                    <View style={{marginTop:10}}>
                        <Text style={[styles.publisher, {width:200}]} numberOfLines={1}>{row.book.publisher}</Text>
                    </View>
                    <View style={{marginTop:10}}>
                        <Text style={[styles.publisher, {width:200}]} numberOfLines={1}>{row.book.author}</Text>
                    </View>
